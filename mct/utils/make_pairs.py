...
#------------------------------
#	Author: Jiawen Kang
#	Note: Make pair data with common genre from 
#              CN-Celeb dataset, for Robust MAML training. 
#-------------------------------
...
sourcedir = "/work5/cslt/kangjiawen/070720-maml-cn2/data/train/txts"
destdir = "/work5/cslt/kangjiawen/070720-maml-cn2/data/train/pairs"
source_list = ['interview', 'movie', 'singing', 'drama', 'entertainment', 'live_broadcast', \
